...
# Challenge: Convert log price estimate using 1970's prices as well as the upper and lower bounds to today's prices
...
def get_dollar_estimate(rm, ptratio, chas=False, large_range=True):
    ...
    ## Docstring (Documentation for this function - Shift Tab to see )
    """Estimate the price of property in Boston
    
    Keyword arguments:
    rm -- Number of rooms per property
    ptratio -- Number of students in a class
    chas -- Next to Charles River?
    large range -- True for a 95% prediction interval and False for 68% prediction interval
